...
public class FilterSingleAdapter<T extends CinemaBean.DataBean> extends BaseAdapter {
    ...
    public FilterSingleAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView.setBackgroundResource(R.drawable.filter_selected_bg);
