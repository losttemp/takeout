...
public abstract class PoifoodSpusListSectionedBaseAdapter extends BaseAdapter implements PoifoodListPinnedHeaderListView.PinnedSectionedHeaderAdapter {
    ...
    public PoifoodSpusListSectionedBaseAdapter() {
        super();
