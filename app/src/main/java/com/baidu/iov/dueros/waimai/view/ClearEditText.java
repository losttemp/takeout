...
//        setFocusable(true);
    ...
    private void showTextClearButton() {
        this.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.mipmap.delete_history, 0);
            ...
            if (mDrawable != null) {
                ...
                if (x > x1 && x < x2 && y > y1 && y < y2) {
                    if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_DOWN) {
                        ClearEditText.this.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.mipmap.delete_history, 0);
